...
export function ThemeVariablesProvider({
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--accent-light", theme.palette.primary.light);
    ...
    root.style.setProperty("--gradient-bg", "linear-gradient(135deg, #0a0f1e 0%, #1a2332 50%, #0a0f1e 100%)");
    root.style.setProperty("--gradient-accent", "linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)");

    // Shadows
    root.style.setProperty("--shadow-glow", "0 8px 32px rgba(0, 0, 0, 0.4), 0 2px 8px rgba(59, 130, 246, 0.2)");
    root.style.setProperty("--shadow-button", "0 4px 12px rgba(59, 130, 246, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)");
    root.style.setProperty("--shadow-button-hover", "0 6px 20px rgba(59, 130, 246, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.3)");
    root.style.setProperty("--shadow-inset", "inset 0 2px 4px rgba(0, 0, 0, 0.3)");
    root.style.setProperty("--shadow-text", "0 2px 4px rgba(0, 0, 0, 0.3)");

    // Borders
    root.style.setProperty("--border-default", "1px solid rgba(59, 130, 246, 0.1)");
    root.style.setProperty("--border-input", "1px solid rgba(59, 130, 246, 0.15)");
    root.style.setProperty("--border-hover", "1px solid rgba(59, 130, 246, 0.3)");
